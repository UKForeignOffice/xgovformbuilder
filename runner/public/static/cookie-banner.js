...
(function (Modules) {
  ...
  CookieBanner.prototype.start = function ($module) {
    ...
    this.$module.cookieBanner = document.querySelector('.rf-cookie-banner')
    this.$module.cookieBannerConfirmationMessage = this.$module.querySelector('.rf-cookie-banner__confirmation')
  ...
  CookieBanner.prototype.showConfirmationMessage = function () {
    this.$cookieBannerMainContent = document.querySelector('.rf-cookie-banner__wrapper')
